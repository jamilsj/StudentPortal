...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "StudentPortal.controller.CameraTest": [],
  "StudentPortal.controller.Main": [],
  ...
  "StudentPortal.custom.PhotoProfile": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "StudentPortal.custom.DatePickerTds": [
    "widget.datePickerTds"
  ],
  "StudentPortal.custom.MyAbsencesListInnerItem": [
    "widget.myabsenceslistinneritem"
  ],
  "StudentPortal.custom.MyAbsencesListItem": [
    "widget.myabsenceslistitem"
  ],
  "StudentPortal.custom.MyAbsencesListView": [
    "widget.myabsenceslistview"
  ],
  "StudentPortal.custom.MyAttendanceListInnerItem": [
    "widget.myattendancelistinneritem"
  ],
  "StudentPortal.custom.MyAttendanceListItem": [
    "widget.myattendancelistitem"
  ],
  "StudentPortal.custom.MyAttendanceListView": [
    "widget.myattListView"
  ],
  "StudentPortal.custom.PhotoProfile": [
    "widget.photoprofile"
  ],
  "StudentPortal.custom.PieChartPanel": [
    "widget.piechartpanel"
  ],
  "StudentPortal.custom.TimePickerField": [
    "widget.timepickerfield"
  ],
  "StudentPortal.form.MyAbsencesForm": [
    "widget.myabsencesform"
  ],
  "StudentPortal.global.Setting": [],
  "StudentPortal.global.Util": [],
  "StudentPortal.model.Absence": [],
  ...
  "StudentPortal.view.MyAbsencesList": [
    "widget.myabsenceslist"
  ],
  "StudentPortal.view.MyAttendance": [
    "widget.myattendance"
  ],
  "StudentPortal.view.MyAttendanceDetail": [
    "widget.myattendancedetail"
  ],
  "StudentPortal.view.MyAttendanceList": [
    "widget.myattendancelist"
  ],
  "StudentPortal.view.Profile": [
    "widget.profile"
  ],
